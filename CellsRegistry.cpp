...
const int tmpArrLen = LOCALITY_RADIUS*2 + 1;
const int tmpArrSize = tmpArrLen*tmpArrLen;

// Created once for all for each thread
// thread_local support is too recent yet
__thread int availablePosTmp[tmpArrSize][2];
